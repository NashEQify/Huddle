...
## 99.23 Color Themes
- 8 color themes available (Terminal Mint, Amber Console, Arctic, High Contrast,
  Lavender Dusk, Rose Terminal, Monochrome, Norton Commander)
- Theme selector in Settings -> COLOR THEME tab (2x4 grid with previews)
